//Лень лезть за полным условием))0
//Если вкратце, то необходимо отсортировать массив пузырьком
//И после каждой итерации записывать в "log.txt" строку в формате год-месяц-день часы:минуты [массив на текущей итерации]
